<?php
// 1. SEGURANÇA E SESSÃO NO TOPO ABSOLUTO (Antes de qualquer HTML ou espaço em branco)
...
<body class="flex min-h-screen bg-meta-fundo text-slate-800 transition-colors duration-200 antialiased">
   ...
   <?php include_once '../includes/sidebarGerente.php'; ?>
    ...
    <!-- Ajustado ml-64 para conversar com a Sidebar Fixa e w-full/overflow para não esmagar -->
    <main class="flex-1 ml-64 p-8 min-w-0 overflow-x-hidden">
        <header class="mb-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-slate-500">Personalize a aparência e functionalities desta página</p>
                </div>
            </div>
        </header>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <div class="xl:col-span-2 space-y-6">
                ...
                <section class="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm">
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-1">
                        <button class="border border-slate-200 py-3 rounded-lg font-medium text-slate-600 hover:bg-slate-50 transition">Pequeno</button>
                        <button class="bg-meta-destaque text-white py-3 rounded-lg font-medium shadow-sm hover:opacity-95 transition">Médio</button>
                        <button class="border border-slate-200 py-3 rounded-lg font-medium text-slate-600 hover:bg-slate-50 transition">Grande</button>
                        <button class="border border-slate-200 py-3 rounded-lg font-medium text-slate-600 hover:bg-slate-50 transition">Extra Grande</button>
                    </div>
                ...
                <section class="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm">
                    ...
                    <div class="space-y-6">
                        <div><label class="text-xs font-bold text-slate-500 uppercase">Título da Página</label><input type="text" value="Transações" class="w-full border border-slate-200 rounded-lg p-3 mt-1 focus:ring-2 focus:ring-meta-destaque outline-none"><p class="text-[10px] text-slate-400 text-right mt-1">10/50</p></div>
                        <div><label class="text-xs font-bold text-slate-500 uppercase">Subtítulo da Página</label><input type="text" value="Gerencie todas as receitas e despesas da empresa" class="w-full border border-slate-200 rounded-lg p-3 mt-1 focus:ring-2 focus:ring-meta-destaque outline-none"><p class="text-[10px] text-slate-400 text-right mt-1">46/100</p></div>
                        <div><label class="text-xs font-bold text-slate-500 uppercase">Texto do Botão Adicionar</label><input type="text" value="Nova Transação" class="w-full border border-slate-200 rounded-lg p-3 mt-1 focus:ring-2 focus:ring-meta-destaque outline-none"><p class="text-[10px] text-slate-400 text-right mt-1">14/30</p></div>
                        <div><label class="text-xs font-bold text-slate-500 uppercase">Texto de Busca (Placeholder)</label><input type="text" value="Buscar transações..." class="w-full border border-slate-200 rounded-lg p-3 mt-1 focus:ring-2 focus:ring-meta-destaque outline-none"><p class="text-[10px] text-slate-400 text-right mt-1">20/50</p></div>
                        <div><label class="text-xs font-bold text-slate-500 uppercase">Mensagem Quando Vazio</label><input type="text" value="Nenhuma transação encontrada" class="w-full border border-slate-200 rounded-lg p-3 mt-1 focus:ring-2 focus:ring-meta-destaque outline-none"><p class="text-[10px] text-slate-400 text-right mt-1">28/60</p></div>
                    </div>
            ...
            <!-- Coluna Lateral: Componentes Visíveis -->
            <div class="xl:col-span-1">
                ...
                <div class="mt-6 space-y-3">
                    <button class="w-full bg-meta-menu text-white py-3 rounded-lg font-bold shadow-md hover:opacity-95 transition"><i class="fas fa-save mr-2"></i> Salvar Alterações</button>
                    <button class="w-full bg-white text-rose-500 border border-rose-200 py-3 rounded-lg font-bold hover:bg-rose-50 transition"><i class="fas fa-trash-alt mr-2"></i> Restaurar Padrão</button>
                </div>
            </div>
        </div>
    </main>
