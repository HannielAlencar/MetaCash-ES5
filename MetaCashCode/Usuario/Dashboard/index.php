        ...
        <main class="flex-1 p-8 ml-64 w-full">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
                <div class="p-6 border-b border-slate-50 flex justify-between items-center">
                    ...
                    <a href="../Transacoes.php/index.php" class="text-xs font-bold text-teal-600 hover:underline uppercase">Ver todas</a>
                </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-[10px] text-gray-500 uppercase font-semibold tracking-wider">
                                    <?php echo $tr['cat']; ?> • <?php echo date('d/m/Y', strtotime($data_exibicao)) . ' ' . date('H:i'); ?>
                                </p>
                            </div>
                        </div>
                        <div class="flex items-center">
