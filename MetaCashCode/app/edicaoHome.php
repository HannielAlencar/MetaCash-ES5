    ...
    <main class="flex-1 ml-64 p-8">
        <header class="mb-6">
            ...
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-teal-600 flex items-center justify-center rounded-lg text-white"><i class="fas fa-home"></i></div>
                <div>
        ...
        <div class="grid grid-cols-3 gap-6">
            <div class="col-span-2 space-y-6">
                <section class="bg-white border border-slate-200 rounded-2xl p-6">
                    <h4 class="font-bold text-slate-800 mb-4 flex items-center"><i class="fas fa-font mr-2 text-slate-400"></i> Textos</h4>
                    <div class="space-y-6">
                        <div><label class="text-xs font-bold text-slate-500 uppercase">Título Principal</label><input type="text" value="MetaCash" class="w-full border border-slate-200 rounded-lg p-3 mt-1"></div>
                        <div><label class="text-xs font-bold text-slate-500 uppercase">Subtítulo</label><textarea class="w-full border border-slate-200 rounded-lg p-3 mt-1 h-20">Gestão Financeira Empresarial Simples e Eficiente</textarea></div>
                    </div>
                </section>
            </div>
            ...
            <div class="col-span-1">
                <section class="bg-white border border-slate-200 rounded-2xl p-6">
                    <h4 class="font-bold text-slate-800 mb-6 flex items-center"><i class="fas fa-palette mr-2 text-slate-400"></i> Gradiente</h4>
                    <div class="space-y-4 mb-6">
                        <div><label class="text-xs font-bold text-slate-500 uppercase">Cor Inicial</label><input type="text" value="#0F2440" class="w-full border border-slate-200 rounded-lg p-3 mt-1"></div>
                        <div><label class="text-xs font-bold text-slate-500 uppercase">Cor Final</label><input type="text" value="#24A6B6" class="w-full border border-slate-200 rounded-lg p-3 mt-1"></div>
                    </div>
