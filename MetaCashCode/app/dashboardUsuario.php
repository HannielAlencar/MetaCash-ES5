...
<head>
    ...
    <script>
        ...
        // Configuração do Tailwind para usar a variável CSS como a fonte padrão (sans)
        tailwind.config = { 
            theme: { 
                extend: { 
                    fontFamily: {
    ...
    <main class="flex-1 p-8 ml-64 min-h-screen overflow-y-auto box-border">
        <div class="max-w-full w-full mx-auto">
            <div class="mb-8">
                ...
                <p class="text-lg text-slate-600 mt-2">Acompanhe o desempenho financeiro do seu perfil</p>
            </div>
