    ...
    <aside class="w-64 bg-[#0f172a] text-white p-4 flex flex-col sticky top-0 h-screen shrink-0">
        ...
        <div class="flex items-center gap-3 mb-10 px-2">
            <div class="w-10 h-10 rounded-lg overflow-hidden flex items-center justify-center shrink-0">
                <img src="/MetaCashCode/Usuario/Dashboard/img/logo empresas.png" alt="MetaCash Logo" class="w-full h-full object-contain" onerror="this.src='https://via.placeholder.com/40?text=MC'">
            </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nome" value="Usuário" class="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 bg-white text-slate-700 focus:ring-2 focus:ring-teal-500 outline-none transition">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="matricula" value="2024001" class="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 bg-white text-slate-700 focus:ring-2 focus:ring-teal-500 outline-none transition">
                                </div>
                                <p class="text-[10px] text-teal-600 mt-1 italic"><i class="fas fa-check"></i> Este campo pode ser alterado</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="cpf" value="123.456.789-00" class="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 bg-white text-slate-700 focus:ring-2 focus:ring-teal-500 outline-none transition">
                                </div>
                                <p class="text-[10px] text-teal-600 mt-1 italic"><i class="fas fa-check"></i> Este campo pode ser alterado</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="w-full px-4 py-3 rounded-xl bg-sky-100 border border-sky-200 text-sky-700 flex items-center gap-3">
                                    ...
                                    <span class="font-bold text-sm">Gerente</span>
                                </div>
