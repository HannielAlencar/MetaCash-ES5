        ...
        <div class="grid grid-cols-3 gap-6">
            <div class="col-span-2 space-y-6">
                <section class="bg-white border border-slate-200 rounded-2xl p-6">
                    ...
                    <select class="w-full border border-slate-200 rounded-lg p-3 mt-1 mb-4 bg-white"><option>Inter</option></select>
                    <label class="text-xs font-bold text-slate-500 uppercase">Tamanho da Fonte</label>
                    <div class="grid grid-cols-2 gap-4 mt-1 mb-2">
                        <button class="border border-slate-200 py-2 rounded-lg text-sm text-slate-600">Pequeno</button>
                        <button class="bg-teal-500 text-white py-2 rounded-lg text-sm">Médio</button>
                        <button class="border border-slate-200 py-2 rounded-lg text-sm text-slate-600">Grande</button>
                        <button class="border border-slate-200 py-2 rounded-lg text-sm text-slate-600">Extra Grande</button>
                    </div>
                </section>
            </div>
                ...
                <section class="bg-white border border-slate-200 rounded-2xl p-6">
                    ...
                    <div class="space-y-3 mb-6">
                        <div class="border border-slate-200 rounded-lg p-3 text-xs">
                            <div class="flex justify-between items-center font-bold mb-2"><span>1 $ Saldo Total</span><div class="flex gap-2"><i class="fas fa-times cursor-pointer"></i></div></div>
                        </div>
                        <div class="border border-slate-200 rounded-lg p-3 flex justify-between items-center text-xs"><span>2 Receitas</span></div>
                        <div class="border border-slate-200 rounded-lg p-3 flex justify-between items-center text-xs"><span>3 Despesas</span></div>
                    </div>
                    <button class="w-full bg-slate-900 text-white py-3 rounded-xl font-bold">Salvar Alterações</button>
                </section>
            </div>
        </div>
    </main>
